...
// let mathScore = prompt("수학 점수를 입력하세요."); // 50
// let engScore = prompt("영어 점수를 입력하세요."); // 50
// let mathNumber = Number(mathScore);
// let engNumber = Number(engScore);
// let avg = (mathNumber + engNumber) / 2;
// console.log(avg);

// console.log(typeof "answk");
// console.log(typeof mathScore); // 타입 "문자열"
// console.log(typeof mathNumber); // 타입 "숫자"
...
console.log(parseInt(n4)); // 123.9에서 소수점은 버리고 정수형으로 변경

console.log(typeof 10 + " isn't " + typeof "" + " data type.");
console.log(typeof 10 + " isn't " + typeof "" + " data type.");

let mathScore = prompt("입력");
let engScore = prompt("입력");
let mathNumber = Number(mathScore);
let engNumber = Number(engScore);
